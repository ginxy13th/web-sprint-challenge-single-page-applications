...
to access a matching path without using a Route .

1. How would you explain form validation to someone who has never programmed before?

it is the devil, no seriously tho, it makes sure that boxes are checked, inputs have values ect. 

1. In 1-2 sentences, define end to end testing.

it tests the functionailty of the entire application not just a component or 2
